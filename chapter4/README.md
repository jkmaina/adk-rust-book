...
- Cargo `1.92+`
- Rust edition `2024`
- Local `adk-rust` `0.8.2` workspace at `../adk-rust`
...
The old archived minimal-agent material is not the active path anymore. The current `0.8.2` baseline is the validated structured-output example plus the Chapter 3 quickstart flow it builds on.
