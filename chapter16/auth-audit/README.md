...
Local `0.8.0` keeps audit close to runtime authorization rather than treating it as an afterthought. This crate stays offline and deterministic, but it teaches the production habit that matters: denied actions belong in the audit trail too.
