...
- local `0.8.2` fixed a sub-agent response-extraction issue that could previously make streamed delegation loops unreliable, which makes this example materially more dependable
