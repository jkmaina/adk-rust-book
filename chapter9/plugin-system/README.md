...
This example shows the runner-level side of the `0.8.2` extension model. Agent callbacks remain useful for local control, but reusable runtime concerns such as lifecycle logging, metrics, and model interception belong more naturally in plugins. That architectural distinction is the main lesson of the crate.
