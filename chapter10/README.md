...
One practical feature-tier note matters here: memory and artifact workflows fit comfortably inside the standard `0.8.0` stack, while RAG belongs to the wider specialist feature surface.
