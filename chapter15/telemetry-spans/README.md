...
Local `0.8.2` gives these span helpers a clearer role in the runtime story. They are not just tracing utilities; they mirror the actual agent, model, tool, and callback boundaries that operators need to inspect when a run becomes slow, expensive, or strange.
